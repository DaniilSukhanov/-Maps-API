...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.label_image, 5, 0, 1, 8)
        ...
        self.gridLayout.addWidget(self.pushButton_load_image, 4, 0, 1, 8)
        self.lineEdit_search = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_search.setObjectName("lineEdit_search")
        self.gridLayout.addWidget(self.lineEdit_search, 2, 0, 1, 7)
        self.pushButton_search = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_search.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.pushButton_search.setObjectName("pushButton_search")
        self.gridLayout.addWidget(self.pushButton_search, 2, 7, 1, 1)
